...
public class BluetoothLeService extends Service {
    ...
    public static final String BATTERY_DATA =
            "com.example.bluetooth.le.BATTER_DATA";
    public static final String BMP_DATA =
            "com.example.bluetooth.le.BMP_DATA";

    //add more dataintent 1. battery service. 2 temp. barometer.
    ...
    public final static UUID UUID_BMP =
            UUID.fromString(SampleGattAttributes.UUID_BMP);
    //Edit by Hill End.
    ...
    private void broadcastUpdate(final String action,
        ...
        if (characteristic.getUuid().equals(UUID_BATTERY_LEVEL)){
            ...
            intent.putExtra(BMP_DATA, characteristic.getValue());
            Log.d(TAG, "BMP_DATA_SENT");
            //intent.putExtra(BMP_DATA, "0xaa");
        }
